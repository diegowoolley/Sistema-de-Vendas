...
namespace Sistema_de_Vendas.Relatorios.Recibos.ReciboPDV
{
    public partial class frmrecibopdv : Form
    {
        public frmrecibopdv()
        {
            InitializeComponent();
        ...
        private void frmrecibopdv_Load(object sender, EventArgs e)
        {
            try
            {
                con.AbrirConexao();
                ...
                this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", ds.Tables[1]));
                this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("DataSet2", ds.Tables[0]));
